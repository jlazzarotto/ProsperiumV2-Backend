...
class ContaFinanceiraSaldoDiario
{
    ...
    public function __construct(int $companyId, Empresa $empresa, UnidadeNegocio $unidade, ContaFinanceira $contaFinanceira, \DateTimeImmutable $dataSaldo, string $saldo) { $this->companyId = $companyId; $this->empresa = $empresa; $this->unidade = $unidade; $this->contaFinanceira = $contaFinanceira; $this->dataSaldo = $dataSaldo; $this->saldo = $saldo; }
    public function getId(): ?int { return $this->id; } public function getCompanyId(): int { return $this->companyId; } public function getDataSaldo(): \DateTimeImmutable { return $this->dataSaldo; } public function getSaldo(): string { return $this->saldo; } public function getContaFinanceira(): ContaFinanceira { return $this->contaFinanceira; }
