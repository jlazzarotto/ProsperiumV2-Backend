...
class LancamentoContabil
{
    ...
    public function __construct(int $companyId, Empresa $empresa, UnidadeNegocio $unidade, ?Titulo $titulo, \DateTimeImmutable $dataLancamento, string $historico, string $status = 'posted') { $this->companyId = $companyId; $this->empresa = $empresa; $this->unidade = $unidade; $this->titulo = $titulo; $this->dataLancamento = $dataLancamento; $this->historico = trim($historico); $this->status = $status; $this->createdAt = new \DateTimeImmutable(); }
    public function getId(): ?int { return $this->id; } public function getCompanyId(): int { return $this->companyId; } public function getEmpresa(): Empresa { return $this->empresa; } public function getUnidade(): UnidadeNegocio { return $this->unidade; } public function getTitulo(): ?Titulo { return $this->titulo; } public function getDataLancamento(): \DateTimeImmutable { return $this->dataLancamento; } public function getHistorico(): string { return $this->historico; } public function getStatus(): string { return $this->status; }
}
