...
class ConciliacaoRegra
{
    ...
    public function __construct(int $companyId, ?Empresa $empresa, ?UnidadeNegocio $unidade, ?ContaFinanceira $contaFinanceira, string $descricaoContains, string $tipoMovimentoSugerido, string $aplicacao, string $status='active')
