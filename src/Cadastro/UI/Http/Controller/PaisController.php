...
use App\Cadastro\Application\Service\PaisService;
...
{
    public function __construct(private readonly PaisService $service, private readonly JsonResponseFactory $responseFactory)
    {
    }
    ...
    public function list(Request $request): JsonResponse
    {
        ...
        $items = $this->service->list($query, $status, $limit);
        return $this->responseFactory->success(['items' => array_map([CadastroResponses::class, 'pais'], $items)]);
    }
}
