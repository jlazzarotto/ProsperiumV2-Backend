...
final class PixCobrancaService
{
    ...
    public function create(CreatePixCobrancaRequest $r): PixCobranca
    {
        ...
        if ($parcela->getCompanyId() !== $company->getId() || $parcela->getEmpresa()->getId() !== $empresa->getId() || $parcela->getUnidade()->getId() !== $unidade->getId()) { throw new ValidationException(['parcelaId' => ['Parcela fora do contexto informado.']]); }
