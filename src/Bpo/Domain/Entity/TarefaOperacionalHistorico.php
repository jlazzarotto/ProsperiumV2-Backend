...
class TarefaOperacionalHistorico
{
    ...
    public function __construct(TarefaOperacionalBpo $tarefa, ?User $user, string $acao, ?string $observacao = null) { $this->tarefa = $tarefa; $this->user = $user; $this->acao = trim($acao); $this->observacao = $observacao !== null ? trim($observacao) : null; $this->createdAt = new \DateTimeImmutable(); }
}
